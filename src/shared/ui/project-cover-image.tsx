  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
        ...
        {category ? (
          <p className="mt-2 text-xs uppercase tracking-[0.2em] text-zinc-400">{category}</p>
        ) : null}
        <p className="mt-3 max-w-xs text-[10px] text-zinc-500 sm:text-xs">Preview placeholder</p>
      </div>
    </div>
  );
};
